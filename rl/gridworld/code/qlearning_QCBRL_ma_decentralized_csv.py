...
class Case:
    ...
    DECREMENT_SUCCESS_NO_CASE = 0.25
    DEL_THRESHOLD = 0.1
...
class QCBRL:
    def __init__(self, num_actions, env, episodes, max_steps, alpha, gamma, epsilon, epsilon_decay, epsilon_min, render, gwidth):
        self.num_actions = num_actions
        self.env = env
    ...
    def save_combined_data_to_csv(data, num_agents):
        ...
        root_folder = 'experiment_results/generated_csv/dsuc-t01_dun05/'
...
if __name__ == "__main__":
    ...
    agent = QCBRL(num_actions, env, episodes, max_steps, alpha, gamma, epsilon, epsilon_decay, epsilon_min, render, gwidth)
