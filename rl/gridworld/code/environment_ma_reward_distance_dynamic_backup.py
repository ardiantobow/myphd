...
class Env(tk.Tk):
    ...
    def _build_canvas(self):
        ...
        self.triangle1 = canvas.create_image(450, 150, image=self.shapes[1])
        self.triangle2 = canvas.create_image(150, 450, image=self.shapes[1])
        self.triangle3 = canvas.create_image(150, 350, image=self.shapes[1])
    ...
    def move_obstacles(self):
        ...
        self.canvas.coords(self.triangle3, positions[0][0], positions[1][1])
        self.canvas.coords(self.triangle4, positions[1][0], positions[0][0]) 
