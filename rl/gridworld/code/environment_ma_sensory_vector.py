...
class Env(tk.Tk):
    ...
    def _build_canvas(self):
        ...
        for agent in self.agents:
            agent['image_obj'] = canvas.create_oval(agent['coords'][0] - 30, agent['coords'][1] - 30,
                                                    agent['coords'][0] + 30, agent['coords'][1] + 30,
        ...
        for i in range(self.num_obstacles):
            ...
            obstacle = canvas.create_rectangle(pos[0] - 30, pos[1] - 30,
                                               pos[0] + 30, pos[1] + 30,
                                               fill='red', outline='black')
            self.obstacles.append(obstacle)

        self.circle = canvas.create_oval(450 - 30, 450 - 30, 450 + 30, 450 + 30, fill='green', outline='black')
    ...
    def reset(self):
        ...
        for agent, pos in zip(self.agents, agent_positions):
            x, y = pos
            self.canvas.coords(agent['image_obj'], x - 30, y - 30, x + 30, y + 30)
            agent['coords'] = [x, y]
